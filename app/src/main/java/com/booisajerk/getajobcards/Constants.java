...
public class Constants {
    ...
    public static final String LOG_TAG_NAME = "Parker ";

    public static final String INSTANCE_STATE_CATEGORY_KEY = "SavedCategoryValue";
    public static final String INSTANCE_STATE_QUESTION_KEY = "SavedQuestionValue";
    public static final String INSTANCE_STATE_ANSWER_KEY = "SavedAnswerValue";
    public static final String INSTANCE_STATE_MORE_KEY = "savedMoreValue";

    public static final String EDIT_TEXT_QUESTION_KEY = "current_question";
